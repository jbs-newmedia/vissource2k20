...
$ddm4_object['database']['table']='vis2_lab_ddm4_summernote';
$ddm4_object['database']['alias']='tbl1';
$ddm4_object['database']['index']='summernote_id';
$ddm4_object['database']['index_type']='integer';
$ddm4_object['database']['order']=[];
$ddm4_object['database']['order']['summernote_id']='desc';
 ...
 */
$osW_DDM4=new osWFrame\Core\DDM4($osW_Template, 'vis2_lab_ddm4_summernote', $ddm4_object);
...
switch ($ddm_navigation_id) {
	case 1:
		 ...
		 * Data: Summernote
		 */
		$ddm4_elements['data']['summernote_example']=[];
		$ddm4_elements['data']['summernote_example']['module']='summernote';
		$ddm4_elements['data']['summernote_example']['title']='Summernote';
		$ddm4_elements['data']['summernote_example']['name']='summernote_example';
		$ddm4_elements['data']['summernote_example']['options']=[];
		$ddm4_elements['data']['summernote_example']['options']['notice']='Default, ohne irgendwelche Einstellungen.';
		break;
	case 2:
		/*
		 * Data: Summernote
		...
		$ddm4_elements['data']['summernote_example']['name']='summernote_example';
		$ddm4_elements['data']['summernote_example']['options']=[];
		$ddm4_elements['data']['summernote_example']['options']['show_dialog']=true;
		$ddm4_elements['data']['summernote_example']['options']['notice']='Optionen und String zwischen 20 und 1200 Zeichen';
		$ddm4_elements['data']['summernote_example']['options']['summernote']=[];
		$ddm4_elements['data']['summernote_example']['options']['summernote']['toolbar']=[];
		$ddm4_elements['data']['summernote_example']['options']['summernote']['toolbar'][]=['style', ['bold', 'italic']];
		$ddm4_elements['data']['summernote_example']['options']['summernote']['toolbar'][]=['font', ['strikethrough', 'superscript', 'subscript']];
		$ddm4_elements['data']['summernote_example']['validation']=[];
		$ddm4_elements['data']['summernote_example']['validation']['module']='string';
		$ddm4_elements['data']['summernote_example']['validation']['length_min']=20;
		$ddm4_elements['data']['summernote_example']['validation']['length_max']=1200;
		break;
	case 99:
		/*
		 * Data: Summernote
		...
		$ddm4_elements['data']['summernote_example']['name']='summernote_example';
		$ddm4_elements['data']['summernote_example']['options']=[];
		$ddm4_elements['data']['summernote_example']['options']['read_only']=true;
		$ddm4_elements['data']['summernote_example']['options']['default_value']=date('d.m.Y H:i:s');
		$ddm4_elements['data']['summernote_example']['options']['notice']='Nur lesend zugreifen';
		break;
}
 ...
 * Data: Required
 */
$ddm4_elements['data']['summernote_check']=[];
$ddm4_elements['data']['summernote_check']['module']='text';
$ddm4_elements['data']['summernote_check']['title']='Required';
$ddm4_elements['data']['summernote_check']['name']='summernote_check';
$ddm4_elements['data']['summernote_check']['options']=[];
$ddm4_elements['data']['summernote_check']['options']['required']=true;
$ddm4_elements['data']['summernote_check']['validation']=[];
$ddm4_elements['data']['summernote_check']['validation']['module']='string';
$ddm4_elements['data']['summernote_check']['validation']['length_min']=1;
$ddm4_elements['data']['summernote_check']['validation']['length_max']=16;
