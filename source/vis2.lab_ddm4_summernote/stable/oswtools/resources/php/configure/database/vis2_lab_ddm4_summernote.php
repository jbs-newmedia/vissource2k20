 ...
 * init
 */
$__datatable_table = 'vis2_lab_ddm4_summernote';
...
if (($av_tbl === 0) && ($ab_tbl === 0)) {
    ...
    $QwriteData->prepare('
CREATE TABLE :table: (
	summernote_id int(11) unsigned NOT NULL AUTO_INCREMENT,
	navigation_id int(11) unsigned NOT NULL DEFAULT 0,
	summernote_example TEXT NOT NULL DEFAULT \'\',
	summernote_check varchar(16) NOT NULL DEFAULT \'\',
