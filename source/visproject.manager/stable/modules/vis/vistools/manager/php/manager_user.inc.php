...
$ddm4_elements['data']['vis_user_tool']['options']['manager']=true;
...
$ddm4_elements['data']['vis_user_group']['options']['manager']=true;
...
$ddm4_elements['data']['vis_user_mandant']['options']['manager']=true;
...
$ddm4_elements['finish']['vis_user_tool_write']['options']['manager']=true;
...
$ddm4_elements['finish']['vis_user_group_write']['options']['manager']=true;
...
$ddm4_elements['finish']['vis_user_mandant_write']['options']['manager']=true;
