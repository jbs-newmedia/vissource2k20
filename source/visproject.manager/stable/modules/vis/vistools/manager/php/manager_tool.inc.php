...
$ddm4_object['general']['status_keys']['tool_status']=[];
$ddm4_object['general']['status_keys']['tool_status'][0]=['value'=>'0', 'class'=>'danger'];
$ddm4_object['data']=[];
...
$ddm4_object['database']['table']='vis_tool';
 ...
 */
$osW_DDM4=new osWFrame\Core\DDM4($osW_Template, 'vis_tool', $ddm4_object);
 ...
 * Data: Status
 */
$ddm4_elements['data']['tool_status']=[];
$ddm4_elements['data']['tool_status']['module']='yesno';
$ddm4_elements['data']['tool_status']['title']='Status';
$ddm4_elements['data']['tool_status']['name']='tool_status';
$ddm4_elements['data']['tool_status']['options']=[];
$ddm4_elements['data']['tool_status']['options']['order']=true;
$ddm4_elements['data']['tool_status']['options']['default_value']=1;
$ddm4_elements['data']['tool_status']['options']['required']=true;
$ddm4_elements['data']['tool_status']['options']['text_yes']='Aktiviert';
$ddm4_elements['data']['tool_status']['options']['text_no']='Deaktiviert';
 ...
 * Data: Benutzer
 */
$ddm4_elements['data']['vis_manager_tool_user']=[];
$ddm4_elements['data']['vis_manager_tool_user']['module']='vis_manager_tool_user';
$ddm4_elements['data']['vis_manager_tool_user']['title']='Benutzer';
...
$ddm4_elements['data']['vis_createupdatestatus']['options']['prefix']='tool_';
...
$ddm4_elements['finish']['vis_store_form_data']['options']['createupdatestatus_prefix']='tool_';

/*
 * Finish: VIS_Manager_Tool_Delete
 */
$ddm4_elements['finish']['vis_manager_tool_delete']=[];
$ddm4_elements['finish']['vis_manager_tool_delete']['module']='vis_manager_tool_delete';
