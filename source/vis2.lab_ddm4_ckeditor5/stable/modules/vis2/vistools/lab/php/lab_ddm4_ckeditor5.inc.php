...
$osW_JSLib=new \osWFrame\Core\JSLib($osW_Template);
$osW_JSLib->load('ckeditor5');
...
$ddm4_object['database']['table']='vis2_lab_ddm4_ckeditor5';
$ddm4_object['database']['alias']='tbl1';
$ddm4_object['database']['index']='ckeditor5_id';
$ddm4_object['database']['index_type']='integer';
$ddm4_object['database']['order']=[];
$ddm4_object['database']['order']['ckeditor5_id']='desc';
 ...
 */
$osW_DDM4=new osWFrame\Core\DDM4($osW_Template, 'vis2_lab_ddm4_ckeditor5', $ddm4_object);
...
$navigation_links[2]=['navigation_id'=>2, 'module'=>$osW_DDM4->getDirectModule(), 'parameter'=>'vistool='.$VIS2_Main->getTool().'&vispage='.$VIS2_Navigation->getPage(), 'text'=>'Minimal'];
...
switch ($ddm_navigation_id) {
	case 1:
		 ...
		 * Data: Ckeditor5
		 */
		$ddm4_elements['data']['ckeditor5_example']=[];
		$ddm4_elements['data']['ckeditor5_example']['module']='ckeditor5';
		$ddm4_elements['data']['ckeditor5_example']['title']='Ckeditor5';
		$ddm4_elements['data']['ckeditor5_example']['name']='ckeditor5_example';
		$ddm4_elements['data']['ckeditor5_example']['options']=[];
		$ddm4_elements['data']['ckeditor5_example']['options']['notice']='Default, ohne irgendwelche Einstellungen.';
		$ddm4_elements['data']['ckeditor5_example']['options']['file']['file_dir']='data/image/';
		$ddm4_elements['data']['ckeditor5_example']['options']['file']['file_name']='md5';
		$ddm4_elements['data']['ckeditor5_example']['options']['file']['file_types']=['image/png'];
		$ddm4_elements['data']['ckeditor5_example']['options']['file']['file_extensions']=['png'];
		$ddm4_elements['data']['ckeditor5_example']['options']['file']['file_size_min']=1048;
		$ddm4_elements['data']['ckeditor5_example']['options']['file']['file_size_max']=2097152;
		$ddm4_elements['data']['ckeditor5_example']['options']['file']['file_width_min']=20;
		$ddm4_elements['data']['ckeditor5_example']['options']['file']['file_width_max']=1280;
		$ddm4_elements['data']['ckeditor5_example']['options']['file']['file_height_min']=20;
		$ddm4_elements['data']['ckeditor5_example']['options']['file']['file_height_max']=800;
		break;
	case 2:
		/*
		 * Data: Ckeditor5
		...
		$ddm4_elements['data']['ckeditor5_example']['options']=[];
		$ddm4_elements['data']['ckeditor5_example']['options']['notice']='Default, ohne irgendwelche Einstellungen.';
		$ddm4_elements['data']['ckeditor5_example']['options']['ckeditor5']=[];
		$ddm4_elements['data']['ckeditor5_example']['options']['ckeditor5']['conf']=[];
		$ddm4_elements['data']['ckeditor5_example']['options']['ckeditor5']['conf']['toolbar']=[];
		$ddm4_elements['data']['ckeditor5_example']['options']['ckeditor5']['conf']['toolbar']['items']=['undo', 'redo', '|', 'removeFormat', 'bold', 'italic', 'strikethrough', 'underline', 'subscript', 'superscript', '|', 'insertTable', 'insertImage', '|', 'sourceEditing'];
		$ddm4_elements['data']['ckeditor5_example']['options']['ckeditor5']['conf']['toolbar']['shouldNotGroupWhenFull']=true;
		$ddm4_elements['data']['ckeditor5_example']['options']['file']['file_dir']='data/image/';
		$ddm4_elements['data']['ckeditor5_example']['options']['file']['file_name']='md5';
		$ddm4_elements['data']['ckeditor5_example']['options']['file']['file_types']=['image/png'];
		$ddm4_elements['data']['ckeditor5_example']['options']['file']['file_extensions']=['png'];
	...
	case 99:
		...
		$ddm4_elements['data']['ckeditor5_example']['name']='ckeditor5_example';
		$ddm4_elements['data']['ckeditor5_example']['options']=[];
		$ddm4_elements['data']['ckeditor5_example']['options']['read_only']=true;
		$ddm4_elements['data']['ckeditor5_example']['options']['default_value']=date('d.m.Y H:i:s');
		$ddm4_elements['data']['ckeditor5_example']['options']['notice']='Nur lesend zugreifen';
		break;
}
 ...
 * Data: Required
 */
$ddm4_elements['data']['ckeditor5_check']=[];
$ddm4_elements['data']['ckeditor5_check']['module']='text';
$ddm4_elements['data']['ckeditor5_check']['title']='Required';
$ddm4_elements['data']['ckeditor5_check']['name']='ckeditor5_check';
$ddm4_elements['data']['ckeditor5_check']['options']=[];
$ddm4_elements['data']['ckeditor5_check']['options']['required']=true;
$ddm4_elements['data']['ckeditor5_check']['validation']=[];
$ddm4_elements['data']['ckeditor5_check']['validation']['module']='string';
$ddm4_elements['data']['ckeditor5_check']['validation']['length_min']=1;
$ddm4_elements['data']['ckeditor5_check']['validation']['length_max']=16;
