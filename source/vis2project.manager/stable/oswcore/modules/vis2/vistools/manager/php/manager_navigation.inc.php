...
$ddm4_object = [];
$ddm4_object['general'] = [];
$ddm4_object['general']['engine'] = 'vis2_formular';
 ...
 */
$osW_DDM4 = new DDM4($osW_Template, 'vis2_navigation', $ddm4_object);
 ...
 */
$var = 'vis2_manager_' . $VIS2_Main->getTool() . '_' . $VIS2_Navigation->getPage() . '_tool_id';
$tool_id = Session::getIntVar($var);
$ar_tools = Manager::getTools();
...
if (($tool_id !== null) && (isset($ar_tools[$tool_id]))) {
    ...
    $_POST['tool_id'] = (int)($_POST['tool_id']);
    $tool_details = Manager::getToolDetails($_POST['tool_id']);

    $navigation_links[0] = [
        'navigation_id' => 0,
        'module' => $osW_DDM4->getDirectModule(),
        'parameter' => 'vistool=' . $VIS2_Main->getTool() . '&vispage=' . $VIS2_Navigation->getPage(),
        'text' => $tool_details['tool_name'],
    ];
    $navigation_links[1] = [
        'navigation_id' => 1,
        'module' => $osW_DDM4->getDirectModule(),
 ...
 * Tool wählen
 */
if (in_array($ddm_navigation_id, [0], true)) {
    /*
    ...
    */
    ...
    $ddm4_elements['send']['tool_id']['options']['data'] = Manager::getTools();
    ...
    /*
     * Finish: VIS2_Manager_Navigation_ToolId
     */
    $ddm4_elements['finish']['vis2_manager_navigation_toolid'] = [];
    $ddm4_elements['finish']['vis2_manager_navigation_toolid']['module'] = 'vis2_manager_navigation_toolid';
    $ddm4_elements['finish']['vis2_manager_navigation_toolid']['options'] = [];
    $ddm4_elements['finish']['vis2_manager_navigation_toolid']['options']['var'] = $var;
    $ddm4_elements['finish']['vis2_manager_navigation_toolid']['options']['element'] = 'tool_id';
 ...
 * Rechte
 */
if (in_array($ddm_navigation_id, [1], true)) {
    ...
    $osW_DDM4->setGroupOption('order', [
        'permission_flag' => 'asc',
    ], 'database');
    $osW_DDM4->setGroupOption('status_keys', [
        'permission_ispublic' => [
            [
                'value' => 'Deaktiviert',
                'class' => 'danger',
    ...
    $ddm4_elements['finish']['vis2_navigation_permission_delete']['options']['tool_id'] = $_POST['tool_id'];
 ...
 * Seiten
 */
if (in_array($ddm_navigation_id, [2], true)) {
    $osW_DDM4->setGroupOption('engine', 'vis2_datatables');
    ...
    $ddm4_elements['data']['vis2_navigation_pages_permission']['options']['tool_id'] = $_POST['tool_id'];
    ...
    $ddm4_elements['finish']['vis2_navigation_pages_permission_write']['options']['tool_id'] = $_POST['tool_id'];
    ...
    $ddm4_elements['finish']['vis2_navigation_pages_permission_delete']['options']['tool_id'] = $_POST['tool_id'];
 ...
 * Navigation
 */
if (in_array($ddm_navigation_id, [3], true)) {
    $osW_DDM4->setGroupOption('engine', 'vis2_datatables');
    ...
    $osW_DDM4->setGroupOption('order', [
        'navigation_intern_sortorder' => 'asc',
    ], 'database');
    $osW_DDM4->setGroupOption('status_keys', [
        'navigation_ispublic' => [
            [
    ...
    $ar_level = [];
    $ar_data[0] = '-';
    foreach (Manager::getNavigationReal(
        0,
        $osW_DDM4->getGroupOption('navigation_level'),
        $_POST['tool_id']
    ) as $navigation_element_1) {
    ...
    $ddm4_elements['data']['page_id']['options']['data'] = Manager::getPagesByToolId($_POST['tool_id']);
    ...
    $ddm4_elements['finish']['vis2_navigation_sort']['options']['tool_id'] = $_POST['tool_id'];
    ...
    */
    ...
    $ddm4_elements['finish']['vis2_navigation_delete']['options']['tool_id'] = $_POST['tool_id'];
 ...
 * Gruppen
 */
if (in_array($ddm_navigation_id, [4], true)) {
    $osW_DDM4->setGroupOption('engine', 'vis2_datatables');
    ...
    $ddm4_elements['data']['vis2_group_permission']['options']['tool_id'] = $_POST['tool_id'];
    ...
    $ddm4_elements['data']['vis2_group_user']['options']['tool_id'] = $_POST['tool_id'];
    ...
    $ddm4_elements['finish']['vis2_group_permission_write']['options']['tool_id'] = $_POST['tool_id'];
    ...
    $ddm4_elements['finish']['vis2_group_user_write']['options']['tool_id'] = $_POST['tool_id'];
    ...
    $ddm4_elements['finish']['vis2_group_delete']['options']['tool_id'] = $_POST['tool_id'];
 ...
 *  Mandanten
 */
if (in_array($ddm_navigation_id, [5], true)) {
    $osW_DDM4->setGroupOption('engine', 'vis2_datatables');
