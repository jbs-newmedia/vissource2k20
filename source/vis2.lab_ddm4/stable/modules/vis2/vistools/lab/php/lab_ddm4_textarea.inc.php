...
$ddm4_object['database']['table']='vis2_lab_ddm4_textarea';
$ddm4_object['database']['alias']='tbl1';
$ddm4_object['database']['index']='textarea_id';
$ddm4_object['database']['index_type']='integer';
$ddm4_object['database']['order']=[];
$ddm4_object['database']['order']['textarea_id']='desc';
 ...
 */
$osW_DDM4=new osWFrame\Core\DDM4($osW_Template, 'vis2_lab_ddm4_textarea', $ddm4_object);
...
switch ($ddm_navigation_id) {
	case 1:
		 ...
		 * Data: Textarea
		 */
		$ddm4_elements['data']['textarea_example']=[];
		$ddm4_elements['data']['textarea_example']['module']='textarea';
		$ddm4_elements['data']['textarea_example']['title']='Textarea';
		$ddm4_elements['data']['textarea_example']['name']='textarea_example';
		$ddm4_elements['data']['textarea_example']['options']=[];
		$ddm4_elements['data']['textarea_example']['options']['notice']='Default, ohne irgendwelche Einstellungen.';
		break;
	case 2:
		/*
		 * Data: Textarea
		...
		$ddm4_elements['data']['textarea_example']['name']='textarea_example';
		$ddm4_elements['data']['textarea_example']['options']=[];
		$ddm4_elements['data']['textarea_example']['options']['notice']='String zwischen 20 und 1200 Zeichen';
		$ddm4_elements['data']['textarea_example']['validation']=[];
		$ddm4_elements['data']['textarea_example']['validation']['module']='string';
		$ddm4_elements['data']['textarea_example']['validation']['length_min']=20;
		$ddm4_elements['data']['textarea_example']['validation']['length_max']=1200;
		break;
	case 99:
		/*
		 * Data: Textarea
		...
		$ddm4_elements['data']['textarea_example']['name']='textarea_example';
		$ddm4_elements['data']['textarea_example']['options']=[];
		$ddm4_elements['data']['textarea_example']['options']['read_only']=true;
		$ddm4_elements['data']['textarea_example']['options']['default_value']=date('d.m.Y H:i:s');
		$ddm4_elements['data']['textarea_example']['options']['notice']='Nur lesend zugreifen';
		break;
}
 ...
 * Data: Required
 */
$ddm4_elements['data']['textarea_check']=[];
$ddm4_elements['data']['textarea_check']['module']='text';
$ddm4_elements['data']['textarea_check']['title']='Required';
$ddm4_elements['data']['textarea_check']['name']='textarea_check';
$ddm4_elements['data']['textarea_check']['options']=[];
$ddm4_elements['data']['textarea_check']['options']['required']=true;
$ddm4_elements['data']['textarea_check']['validation']=[];
$ddm4_elements['data']['textarea_check']['validation']['module']='string';
$ddm4_elements['data']['textarea_check']['validation']['length_min']=1;
$ddm4_elements['data']['textarea_check']['validation']['length_max']=16;
