...
$data=['Michael Muster', 'Annabelle Muster', 'Jürgen Müster'];
...
$ddm4_object['database']['table']='vis2_lab_ddm4_bitmask';
$ddm4_object['database']['alias']='tbl1';
$ddm4_object['database']['index']='bitmask_id';
$ddm4_object['database']['index_type']='integer';
$ddm4_object['database']['order']=[];
$ddm4_object['database']['order']['bitmask_id']='desc';
...
switch ($ddm_navigation_id) {
	case 1:
		 ...
		 * Data: BitMask
		 */
		$ddm4_elements['data']['bitmask_example']=[];
		$ddm4_elements['data']['bitmask_example']['module']='bitmask';
		$ddm4_elements['data']['bitmask_example']['title']='BitMask';
		$ddm4_elements['data']['bitmask_example']['name']='bitmask_example';
		$ddm4_elements['data']['bitmask_example']['options']=[];
		$ddm4_elements['data']['bitmask_example']['options']['notice']='Default, ohne irgendwelche Einstellungen.';
		$ddm4_elements['data']['bitmask_example']['options']['ajax_enabled']=false;
		$ddm4_elements['data']['bitmask_example']['options']['data']=$data;
		break;
	case 2:
		/*
		 * Data: BitMask
		...
		$ddm4_elements['data']['bitmask_example']['name']='bitmask_example';
		$ddm4_elements['data']['bitmask_example']['options']=[];
		$ddm4_elements['data']['bitmask_example']['options']['orientation']='horizontal';
		$ddm4_elements['data']['bitmask_example']['options']['notice']='Default, ohne irgendwelche Einstellungen.';
		$ddm4_elements['data']['bitmask_example']['options']['ajax_enabled']=false;
		$ddm4_elements['data']['bitmask_example']['options']['data']=$data;
		break;
	case 99:
		...
		$ddm4_elements['data']['bitmask_example']['name']='bitmask_example';
		$ddm4_elements['data']['bitmask_example']['options']=[];
		$ddm4_elements['data']['bitmask_example']['options']['read_only']=true;
		$ddm4_elements['data']['bitmask_example']['options']['data']=$data;
		$ddm4_elements['data']['bitmask_example']['options']['notice']='Nur lesend zugreifen';
		break;
}
 ...
 * Data: Required
 */
$ddm4_elements['data']['bitmask_check']=[];
$ddm4_elements['data']['bitmask_check']['module']='text';
$ddm4_elements['data']['bitmask_check']['title']='Required';
$ddm4_elements['data']['bitmask_check']['name']='bitmask_check';
$ddm4_elements['data']['bitmask_check']['options']=[];
$ddm4_elements['data']['bitmask_check']['options']['required']=true;
$ddm4_elements['data']['bitmask_check']['validation']=[];
$ddm4_elements['data']['bitmask_check']['validation']['module']='string';
$ddm4_elements['data']['bitmask_check']['validation']['length_min']=1;
$ddm4_elements['data']['bitmask_check']['validation']['length_max']=16;
