...
$ddm4_object['database']['table']='vis2_lab_ddm4_date';
$ddm4_object['database']['alias']='tbl1';
$ddm4_object['database']['index']='date_id';
$ddm4_object['database']['index_type']='integer';
$ddm4_object['database']['order']=[];
$ddm4_object['database']['order']['date_id']='desc';
...
switch ($ddm_navigation_id) {
	case 1:
		 ...
		 * Data: Datum
		 */
		$ddm4_elements['data']['date_example']=[];
		$ddm4_elements['data']['date_example']['module']='date';
		$ddm4_elements['data']['date_example']['title']='Datum';
		$ddm4_elements['data']['date_example']['name']='date_example';
		$ddm4_elements['data']['date_example']['options']=[];
		$ddm4_elements['data']['date_example']['options']['notice']='Default, mit Monat als Name.';
		$ddm4_elements['data']['date_example']['options']['month_asname']=true;
		break;
	case 99:
		/*
		 * Data: Datum
		...
		$ddm4_elements['data']['date_example']['name']='date_example';
		$ddm4_elements['data']['date_example']['options']=[];
		$ddm4_elements['data']['date_example']['options']['read_only']=true;
		$ddm4_elements['data']['date_example']['options']['notice']='Nur lesend zugreifen';
		$ddm4_elements['data']['date_example']['options']['default_value']=date('Ymd');
		break;
}
 ...
 * Data: Required
 */
$ddm4_elements['data']['date_check']=[];
$ddm4_elements['data']['date_check']['module']='text';
$ddm4_elements['data']['date_check']['title']='Required';
$ddm4_elements['data']['date_check']['name']='date_check';
$ddm4_elements['data']['date_check']['options']=[];
$ddm4_elements['data']['date_check']['options']['required']=true;
$ddm4_elements['data']['date_check']['validation']=[];
$ddm4_elements['data']['date_check']['validation']['module']='string';
$ddm4_elements['data']['date_check']['validation']['length_min']=1;
$ddm4_elements['data']['date_check']['validation']['length_max']=16;
