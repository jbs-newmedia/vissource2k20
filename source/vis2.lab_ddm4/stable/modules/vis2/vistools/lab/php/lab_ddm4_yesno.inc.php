...
$ddm4_object['database']['table']='vis2_lab_ddm4_yesno';
$ddm4_object['database']['alias']='tbl1';
$ddm4_object['database']['index']='yesno_id';
$ddm4_object['database']['index_type']='integer';
$ddm4_object['database']['order']=[];
$ddm4_object['database']['order']['yesno_id']='desc';
...
$navigation_links[3]=['navigation_id'=>3, 'module'=>$osW_DDM4->getDirectModule(), 'parameter'=>'vistool='.$VIS2_Main->getTool().'&vispage='.$VIS2_Navigation->getPage(), 'text'=>'Reihenfolge'];
$navigation_links[4]=['navigation_id'=>4, 'module'=>$osW_DDM4->getDirectModule(), 'parameter'=>'vistool='.$VIS2_Main->getTool().'&vispage='.$VIS2_Navigation->getPage(), 'text'=>'Pflicht'];
...
switch ($ddm_navigation_id) {
	case 1:
		 ...
		 * Data: YesNo
		 */
		$ddm4_elements['data']['yesno_example']=[];
		$ddm4_elements['data']['yesno_example']['module']='yesno';
		$ddm4_elements['data']['yesno_example']['title']='YesNo';
		$ddm4_elements['data']['yesno_example']['name']='yesno_example';
		$ddm4_elements['data']['yesno_example']['options']=[];
		$ddm4_elements['data']['yesno_example']['options']['notice']='Default, ohne irgendwelche Einstellungen';
		break;
	case 2:
		/*
		 * Data: YesNo
		...
		$ddm4_elements['data']['yesno_example']['name']='yesno_example';
		$ddm4_elements['data']['yesno_example']['options']=[];
		$ddm4_elements['data']['yesno_example']['options']['text_yes']='aktiviert';
		...
		$ddm4_elements['data']['yesno_example']['name']='yesno_example';
		$ddm4_elements['data']['yesno_example']['options']=[];
		$ddm4_elements['data']['yesno_example']['options']['displayorder']='ny';
		$ddm4_elements['data']['yesno_example']['options']['notice']='No/Yes anstatt Yes/No';
		break;
	case 4:
		/*
		 * Data: YesNo
		...
		$ddm4_elements['data']['yesno_example']['name']='yesno_example';
		$ddm4_elements['data']['yesno_example']['options']=[];
		$ddm4_elements['data']['yesno_example']['options']['required']=true;
		$ddm4_elements['data']['yesno_example']['options']['notice']='Default, ohne irgendwelche Einstellungen';
		break;
	case 99:
		/*
		...
		$ddm4_elements['data']['yesno_example']['name']='yesno_example';
		$ddm4_elements['data']['yesno_example']['options']=[];
		$ddm4_elements['data']['yesno_example']['options']['read_only']=true;
		$ddm4_elements['data']['yesno_example']['options']['default_value']=true;
		$ddm4_elements['data']['yesno_example']['options']['notice']='Nur lesend zugreifen';
		break;
}
 ...
 * Data: Required
 */
$ddm4_elements['data']['yesno_check']=[];
$ddm4_elements['data']['yesno_check']['module']='text';
$ddm4_elements['data']['yesno_check']['title']='Required';
$ddm4_elements['data']['yesno_check']['name']='yesno_check';
$ddm4_elements['data']['yesno_check']['options']=[];
$ddm4_elements['data']['yesno_check']['options']['required']=true;
$ddm4_elements['data']['yesno_check']['validation']=[];
$ddm4_elements['data']['yesno_check']['validation']['module']='string';
$ddm4_elements['data']['yesno_check']['validation']['length_min']=1;
$ddm4_elements['data']['yesno_check']['validation']['length_max']=16;
