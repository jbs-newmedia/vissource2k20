...
$ddm4_object['database']['table']='vis2_lab_ddm4_select';
$ddm4_object['database']['alias']='tbl1';
$ddm4_object['database']['index']='select_id';
$ddm4_object['database']['index_type']='integer';
$ddm4_object['database']['order']=[];
$ddm4_object['database']['order']['select_id']='desc';
...
$navigation_links[2]=['navigation_id'=>2, 'module'=>$osW_DDM4->getDirectModule(), 'parameter'=>'vistool='.$VIS2_Main->getTool().'&vispage='.$VIS2_Navigation->getPage(), 'text'=>'Länder'];
$navigation_links[3]=['navigation_id'=>3, 'module'=>$osW_DDM4->getDirectModule(), 'parameter'=>'vistool='.$VIS2_Main->getTool().'&vispage='.$VIS2_Navigation->getPage(), 'text'=>'Leer'];
...
switch ($ddm_navigation_id) {
	case 1:
		 ...
		 * Data: Select
		 */
		$ddm4_elements['data']['select_example']=[];
		$ddm4_elements['data']['select_example']['module']='select';
		$ddm4_elements['data']['select_example']['title']='Select';
		$ddm4_elements['data']['select_example']['name']='select_example';
		$ddm4_elements['data']['select_example']['options']=[];
		$ddm4_elements['data']['select_example']['options']['notice']='Default, ohne irgendwelche Einstellungen.';
		break;
	case 2:
		/*
		 * Data: Select
		...
		$ddm4_elements['data']['select_example']['name']='select_example';
		$ddm4_elements['data']['select_example']['options']=[];
		$ddm4_elements['data']['select_example']['options']['notice']='Länder';
		$ddm4_elements['data']['select_example']['options']['data']=['Deutschland', 'Österreich', 'Schweiz'];
		break;
	case 3:
		/*
		 * Data: Select
		...
		$ddm4_elements['data']['select_example']['options']['notice']='Länder';
		$ddm4_elements['data']['select_example']['options']['data']=['Deutschland', 'Österreich', 'Schweiz'];
		$ddm4_elements['data']['select_example']['options']['blank_value']=false;
		break;
	case 99:
		/*
		 * Data: Select
		...
		$ddm4_elements['data']['select_example']['name']='select_example';
		$ddm4_elements['data']['select_example']['options']=[];
		$ddm4_elements['data']['select_example']['options']['read_only']=true;
		$ddm4_elements['data']['select_example']['options']['data']=[];
		$ddm4_elements['data']['select_example']['options']['data']=['Deutschland', 'Österreich', 'Schweiz'];
		$ddm4_elements['data']['select_example']['options']['default_value']=1;
		$ddm4_elements['data']['select_example']['options']['notice']='Nur lesend zugreifen';
		break;
}
 ...
 * Data: Required
 */
$ddm4_elements['data']['select_check']=[];
$ddm4_elements['data']['select_check']['module']='text';
$ddm4_elements['data']['select_check']['title']='Required';
$ddm4_elements['data']['select_check']['name']='select_check';
$ddm4_elements['data']['select_check']['options']=[];
$ddm4_elements['data']['select_check']['options']['required']=true;
$ddm4_elements['data']['select_check']['validation']=[];
$ddm4_elements['data']['select_check']['validation']['module']='string';
$ddm4_elements['data']['select_check']['validation']['length_min']=1;
$ddm4_elements['data']['select_check']['validation']['length_max']=16;
