 ...
 * init
 */
$__datatable_table='vis2_lab_ddm4_timestamp';
...
if (($av_tbl==0)&&($ab_tbl==0)) {
	...
	$QwriteData->prepare('
CREATE TABLE :table: (
	timestamp_id int(11) unsigned NOT NULL AUTO_INCREMENT,
	navigation_id int(11) unsigned NOT NULL DEFAULT 0,
	timestamp_example int(6) unsigned NOT NULL DEFAULT 0,
	timestamp_check int(11) NOT NULL DEFAULT 0,
