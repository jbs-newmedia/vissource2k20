 ...
 * init
 */
$__datatable_table='vis2_lab_ddm4_multicheckbox';
...
CREATE TABLE :table: (
	multicheckbox_id int(11) unsigned NOT NULL AUTO_INCREMENT,
	navigation_id int(11) unsigned NOT NULL DEFAULT 0,
	multicheckbox_example varchar(16) NOT NULL DEFAULT \'\',
	multicheckbox_check varchar(16) NOT NULL DEFAULT \'\',
