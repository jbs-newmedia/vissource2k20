 ...
 * init
 */
$__datatable_table='vis2_lab_ddm4_file';
...
CREATE TABLE :table: (
	...
	file_example varchar(255) NOT NULL DEFAULT \'\',
	file_example_name varchar(255) NOT NULL DEFAULT \'\',
	file_example_type varchar(32) NOT NULL DEFAULT \'\',
	file_example_size int(11) unsigned NOT NULL DEFAULT 0,
	file_example_md5 varchar(32) NOT NULL DEFAULT \'\',
	file_example_sha1 varchar(40) NOT NULL DEFAULT \'\',
	file_check varchar(16) NOT NULL DEFAULT \'\',
