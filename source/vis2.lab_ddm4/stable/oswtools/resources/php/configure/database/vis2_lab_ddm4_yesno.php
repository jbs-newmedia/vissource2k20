 ...
 * init
 */
$__datatable_table='vis2_lab_ddm4_yesno';
...
if (($av_tbl==0)&&($ab_tbl==0)) {
	...
	$QwriteData->prepare('
CREATE TABLE :table: (
	yesno_id int(11) unsigned NOT NULL AUTO_INCREMENT,
	navigation_id int(11) unsigned NOT NULL DEFAULT 0,
	yesno_example varchar(1) NOT NULL DEFAULT \'\',
	yesno_check varchar(16) NOT NULL DEFAULT \'\',
