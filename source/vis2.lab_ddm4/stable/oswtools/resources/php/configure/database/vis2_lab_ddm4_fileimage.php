 ...
 * init
 */
$__datatable_table = 'vis2_lab_ddm4_fileimage';
...
if (($av_tbl === 0) && ($ab_tbl === 0)) {
    ...
    $QwriteData->prepare('
CREATE TABLE :table: (
	fileimage_id int(11) unsigned NOT NULL AUTO_INCREMENT,
	navigation_id int(11) unsigned NOT NULL DEFAULT 0,
	fileimage_example varchar(255) NOT NULL DEFAULT \'\',
	fileimage_example_name varchar(255) NOT NULL DEFAULT \'\',
	fileimage_example_type varchar(32) NOT NULL DEFAULT \'\',
	fileimage_example_size int(11) unsigned NOT NULL DEFAULT 0,
	fileimage_example_md5 varchar(32) NOT NULL DEFAULT \'\',
	fileimage_example_sha1 varchar(40) NOT NULL DEFAULT \'\',
	fileimage_check varchar(16) NOT NULL DEFAULT \'\',
