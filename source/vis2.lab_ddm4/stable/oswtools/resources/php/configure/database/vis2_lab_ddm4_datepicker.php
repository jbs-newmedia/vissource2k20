 ...
 * init
 */
$__datatable_table='vis2_lab_ddm4_datepicker';
...
CREATE TABLE :table: (
	datepicker_id int(11) unsigned NOT NULL AUTO_INCREMENT,
	navigation_id int(11) unsigned NOT NULL DEFAULT 0,
	datepicker_example int(6) unsigned NOT NULL DEFAULT 0,
	datepicker_check varchar(16) NOT NULL DEFAULT \'\',
