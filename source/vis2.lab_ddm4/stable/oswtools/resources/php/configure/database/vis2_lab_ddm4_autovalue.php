 ...
 * init
 */
$__datatable_table='vis2_lab_ddm4_autovalue';
...
if (($av_tbl==0)&&($ab_tbl==0)) {
	...
	$QwriteData->prepare('
CREATE TABLE :table: (
	autovalue_id int(11) unsigned NOT NULL AUTO_INCREMENT,
	navigation_id int(11) unsigned NOT NULL DEFAULT 0,
	autovalue_example int(11) unsigned NOT NULL DEFAULT 0,
	autovalue_check varchar(16) NOT NULL DEFAULT \'\',
