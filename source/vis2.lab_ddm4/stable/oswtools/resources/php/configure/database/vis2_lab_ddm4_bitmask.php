 ...
 * init
 */
$__datatable_table='vis2_lab_ddm4_bitmask';
...
if (($av_tbl==0)&&($ab_tbl==0)) {
	...
	$QwriteData->prepare('
CREATE TABLE :table: (
	bitmask_id int(11) unsigned NOT NULL AUTO_INCREMENT,
	navigation_id int(11) unsigned NOT NULL DEFAULT 0,
	bitmask_example varchar(16) NOT NULL DEFAULT \'\',
	bitmask_check varchar(16) NOT NULL DEFAULT \'\',
