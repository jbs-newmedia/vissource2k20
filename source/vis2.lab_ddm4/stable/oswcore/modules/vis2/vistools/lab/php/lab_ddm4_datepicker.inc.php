...
$ddm4_object['database']['table'] = 'vis2_lab_ddm4_datepicker';
$ddm4_object['database']['alias'] = 'tbl1';
$ddm4_object['database']['index'] = 'datepicker_id';
$ddm4_object['database']['index_type'] = 'integer';
$ddm4_object['database']['order'] = [];
$ddm4_object['database']['order']['datepicker_id'] = 'desc';
...
switch ($ddm_navigation_id) {
    case 1:
         ...
         * Data: Datum
         */
        $ddm4_elements['data']['datepicker_example'] = [];
        $ddm4_elements['data']['datepicker_example']['module'] = 'datepicker';
        $ddm4_elements['data']['datepicker_example']['title'] = 'Datum';
        $ddm4_elements['data']['datepicker_example']['name'] = 'datepicker_example';
        $ddm4_elements['data']['datepicker_example']['options'] = [];
        $ddm4_elements['data']['datepicker_example']['options']['notice'] = 'Default';
    ...
    case 99:
        ...
        $ddm4_elements['data']['datepicker_example']['name'] = 'datepicker_example';
        $ddm4_elements['data']['datepicker_example']['options'] = [];
        $ddm4_elements['data']['datepicker_example']['options']['read_only'] = true;
        $ddm4_elements['data']['datepicker_example']['options']['notice'] = 'Nur lesend zugreifen';
        $ddm4_elements['data']['datepicker_example']['options']['default_value'] = date('Ymd');
 ...
 * Data: Required
 */
$ddm4_elements['data']['datepicker_check'] = [];
$ddm4_elements['data']['datepicker_check']['module'] = 'text';
$ddm4_elements['data']['datepicker_check']['title'] = 'Required';
$ddm4_elements['data']['datepicker_check']['name'] = 'datepicker_check';
$ddm4_elements['data']['datepicker_check']['options'] = [];
$ddm4_elements['data']['datepicker_check']['options']['required'] = true;
$ddm4_elements['data']['datepicker_check']['validation'] = [];
$ddm4_elements['data']['datepicker_check']['validation']['module'] = 'string';
$ddm4_elements['data']['datepicker_check']['validation']['length_min'] = 1;
$ddm4_elements['data']['datepicker_check']['validation']['length_max'] = 16;
