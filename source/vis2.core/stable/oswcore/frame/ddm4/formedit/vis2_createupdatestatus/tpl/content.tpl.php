...
<?php if ($this->getEditElementValue($element, 'title') !== ''): ?>
    <h4 class="form-group bg-primary text-white ddm4_element_header ddm_element_<?php echo $this->getEditElementValue(
        $element,
        'id'
    ) ?>"><?php echo HTML::outputString($this->getEditElementValue($element, 'title')) ?></h4>
<?php endif ?>
...
<?php if ($this->getEditElementOption($element, 'display_create_time') === true): ?>
    <div class="form-group ddm_element_<?php echo $this->getEditElementValue($element, 'id') ?>">
        <label
            class="form-control-label"><?php echo HTML::outputString(
                $this->getEditElementOption($element, 'text_create_time')
        ...
        <?php if (($this->getEditElementStorage(
        ...
        <?php else: ?><?php if ($this->getEditElementOption($element, 'month_asname') === true): ?>
            <div
                class="form-control readonly"><?php echo \osWFrame\Core\DateTime::strftime(
                    ...
                    $this->getEditElementStorage($this->getEditElementOption($element, 'prefix') . 'create_time')
...
<?php if ($this->getEditElementOption($element, 'display_create_user') === true): ?>
    <div class="form-group ddm_element_<?php echo $this->getEditElementValue($element, 'id') ?>">
        <label
            class="form-control-label"><?php echo HTML::outputString(
                $this->getEditElementOption($element, 'text_create_user')
            ) ?><?php if ($this->getEditElementOption(
                $element,
                'required'
            ) === true
        ...
        <?php if (($this->getEditElementStorage(
            ...
            $this->getEditElementStorage($this->getEditElementOption($element, 'prefix') . 'create_user_id')
        ) === '')
        ): ?>
            <div class="form-control readonly">---</div>
        <?php else: ?>
...
<?php if ($this->getEditElementOption($element, 'display_update_time') === true): ?>
    <div class="form-group ddm_element_<?php echo $this->getEditElementValue($element, 'id') ?>">
        <label
            class="form-control-label"><?php echo HTML::outputString(
                $this->getEditElementOption($element, 'text_update_time')
            ) ?><?php if ($this->getEditElementOption(
                $element,
                'required'
            ) === true
        ...
        <?php else: ?><?php if ($this->getEditElementOption($element, 'month_asname') === true): ?>
            <div
                class="form-control readonly"><?php echo \osWFrame\Core\DateTime::strftime(
                    str_replace('%m.', ' %B ', $this->getEditElementOption($element, 'date_format')),
                    $this->getEditElementStorage($this->getEditElementOption($element, 'prefix') . 'update_time')
                ) ?><?php echo HTML::outputString($this->getGroupMessage('text_clock')) ?></div>
        <?php else: ?>
            <div
                class="form-control readonly"><?php echo \osWFrame\Core\DateTime::strftime(
...
<?php if ($this->getEditElementOption($element, 'display_update_user') === true): ?>
    <div class="form-group ddm_element_<?php echo $this->getEditElementValue($element, 'id') ?>">
        <label
            class="form-control-label"><?php echo HTML::outputString(
                $this->getEditElementOption($element, 'text_update_user')
            ) ?><?php if ($this->getEditElementOption(
                $element,
                'required'
            ) === true
        ...
        <?php if (($this->getEditElementStorage(
            ...
            $this->getEditElementStorage($this->getEditElementOption($element, 'prefix') . 'update_user_id')
        ) === '')
        ): ?>
            <div class="form-control readonly">---</div>
        <?php else: ?>
