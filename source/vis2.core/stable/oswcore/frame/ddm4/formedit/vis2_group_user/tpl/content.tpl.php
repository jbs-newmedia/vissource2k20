...
<div class="form-group ddm_element_<?php echo $this->getEditElementValue($element, 'id') ?>">
    ...
    <?php if ($this->getEditElementOption($element, 'read_only') === true): ?>
        ...
        <?php foreach ($users as $user_id => $user_name): ?><?php if ((isset($ar_tool_user[$user_id])) && ($ar_tool_user[$user_id] === 1)): ?>
    ...
    <?php else: ?>
        ...
        <?php if (count($users) > (int)($this->getEditElementOption($element, 'search_mod_counter'))): ?>
