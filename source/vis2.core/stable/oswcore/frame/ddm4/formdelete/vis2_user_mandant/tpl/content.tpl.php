...
<div class="form-group ddm_element_<?php echo $this->getDeleteElementValue($element, 'id') ?>">
    ...
    <?php if ($this->getDeleteElementOption($element, 'manager') === true): ?>
        ...
        <?php foreach (Manager::getTools() as $tool_id => $tool_name): ?>
            ...
            <?php if ($tool_details['tool_use_mandant'] === 1): ?>
                ...
                <?php foreach (Manager::getMandantenByToolId($tool_id, true) as $group_id => $group_name): ?>

                    <div class="custom-checkbox">
                        <?php if ((isset($ar_user_mandant[$tool_id]) && (isset($ar_user_mandant[$tool_id][$group_id]))) && ($ar_user_mandant[$tool_id][$group_id] === 1)): ?><?php echo $this->getGroupMessage(
                            'log_char_true'
    ...
    <?php else: ?>
        ...
        <?php foreach (Manager::getMandantenByToolId(
            ...
            <div class="custom-checkbox">
                <?php if ((isset(
                    $ar_user_mandant[$this->getDeleteElementOption(
                        $element,
                        'tool_id'
                    )]
                ) && (isset(
                ...
                ))) && ($ar_user_mandant[$this->getDeleteElementOption($element, 'tool_id')][$group_id] === 1)
