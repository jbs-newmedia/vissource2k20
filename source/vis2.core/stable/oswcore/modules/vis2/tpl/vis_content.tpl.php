...
<?php else: ?>
           ...
           href="<?php echo $this->buildHrefLink(
            ...
            <div class="navbar-brand-icon">
                <?php if (pathinfo(Settings::getStringVar('vis2_logo_navi_name'), \PATHINFO_EXTENSION) === 'svg'): ?>
                    ...
                    <img style="height:<?php echo Settings::getIntVar('vis2_logo_navi_height') ?>px"
            ...
            <div
                class="navbar-brand-text text-primary ms-2 fs-5"><?php if (Settings::getStringVar(
                    'vis2_tool_' . $VIS2_Main->getTool() . '_title'
                ) !== null
                ): ?><?php echo Settings::getStringVar(
                    'vis2_tool_' . $VIS2_Main->getTool() . '_title'
                ) ?><?php else: ?><?php echo $VIS2_Main->getToolName(); ?><?php endif ?></div>
        </a>
            ...
            <div class="dropdown ms-auto">
                <a href="#" class="d-flex align-items-center link-dark text-decoration-none" id="dropdownUser2"
                   data-bs-toggle="dropdown" aria-expanded="false">
                    <span
                        class="text-gray-600 ms-2 d-none d-md-block"><?php echo HTML::outputString(
                            $VIS2_User->getDisplayName(false)
                        ) ?></span>
                    <img src="<?php echo $VIS2_User->getProfileImage(); ?>" height="46" class="ms-2"></a>
                <ul class="dropdown-menu dropdown-menu-end text-small shadow" aria-labelledby="dropdownUser2">
                    <li>
                        <a class="dropdown-item<?php if ($VIS2_Navigation->getPage(
                        ) === 'vis_profile'
                        ): ?> active<?php endif ?>"
                           href="<?php echo $this->buildHrefLink(
                               'current',
                        ...
                        <a class="dropdown-item<?php if ($VIS2_Navigation->getPage(
                           ...
                           href="<?php echo $this->buildHrefLink(
                               ...
                               'vistool=' . $VIS2_Main->getTool() . '&vispage=vis_settings'
                                ...
                                class="fas fa-cogs fa-sm fa-fw mr-2 text-gray-400"></i> Einstellungen</a>
                    </li>
                    <li>
                        ...
                        <a class="dropdown-item"
                           href="<?php echo $this->buildHrefLink(
                               ...
                               'vistool=' . $VIS2_Main->getTool() . '&vispage=vis_logout'
                                ...
                                class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400"></i> Abmelden</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="d-flex w-100" id="jbsadmin-wrapper">
        ...
        <div id="jbsadmin-sidebar" class="sidebar collapse show me-2">
            ...
            <div class="bg-primary bg-gradient-dark-25-gradient-dark"
                 style="width:14rem; position: fixed; float:left; height: 100%; background-attachment: fixed; z-index: -1;"></div>

            <a class="navbar-brand d-flex align-items-center bg-white position-fixed"
               href="<?php echo $this->buildHrefLink(
                   'current',
                   'vistool=' . $VIS2_Main->getTool() . '&vispage=vis_dashboard'
               ) ?>">
            ...
            <div id="jbsadmin-sidebar-nav" class="pt-3">
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start"
                    id="jbsadmin-sidebar-navigation">

                    <li class="nav-item w-100<?php if ($VIS2_Navigation->getPage(
                    ) === 'vis_dashboard'
                    ): ?> active<?php endif ?>">
                        ...
                        <?php foreach ($VIS2_Navigation->getNavigationWithPermission(0, 2) as $navigation_element): ?>
                            ...
                            <?php if ($navigation_element['info']['permission_link'] === true): ?>
                                ...
                                <?php if (count($navigation_element['links']) > 0): ?>
                                    ...
                                    <a href="#navi_vis2_<?php echo $navigation_element['info']['navigation_id'] ?>"
                                       class="nav-link" data-bs-toggle="collapse">
                                        <span><?php echo HTML::outputString(
                                            $navigation_element['info']['navigation_title']
                                        ) ?></span></a>
                                    <div
                                        class="collapse nav flex-column<?php if ($navigation_element['info']['navigation_active'] === true): ?> show<?php endif ?>"
                                        id="navi_vis2_<?php echo $navigation_element['info']['navigation_id'] ?>"
                                            ...
                                            <?php foreach ($navigation_element['links'] as $navigation_element): ?>
                                                ...
                                                <?php if ($navigation_element['info']['permission_link'] === true): ?>
                                                    ...
                                                    <?php if ($navigation_element['info']['permission_view'] === true): ?>
                                                        <a class="collapse-item<?php if ($navigation_element['info']['navigation_active'] === true): ?> active<?php endif ?>" href="<?php echo $this->buildHrefLink(
                                                            'current',
                                                    ...
                                                    <?php if (($navigation_element['info']['page_name_intern'] !== null) && (Badge::get(
                                                        ...
                                                        <span class="vis2_navigation_badge"
                                ...
                                <div class="collapse nav flex-column" id="vis2_mandant"
                                    ...
                                    <div class="nav-sub p-2 mb-2">
                                        ...
                                        <?php foreach ($VIS2_User->getMandantenSelectArray(
                                            ...
                                            <a class="collapse-item<?php if ($VIS2_Mandant->getId(
                                            ) === $mandant_id
                                            ): ?> active<?php endif ?>"
                                               href="<?php echo $this->buildhrefLink(
                                                   'current',
                                ...
                                <div class="collapse nav flex-column" id="vis2_tool"
                                    ...
                                    <div class="nav-sub p-2 mb-2">
                                        ...
                                        <?php foreach ($VIS2_User->getToolsSelectArray(
                                            ...
                                            <a class="collapse-item<?php if ($VIS2_Main->getTool(
                                            ) === $vis_tool
                                            ): ?> active<?php endif ?>"
                                               href="<?php echo $this->buildHrefLink(
                                                   'current',
                    ...
                    <li class="nav-item w-100 mt-3 mb-3 pb-4 text-center">
                        <button id="sidebarToggle"
                                class="btn btn-link rounded-circle text-center text-light border bg-light"
