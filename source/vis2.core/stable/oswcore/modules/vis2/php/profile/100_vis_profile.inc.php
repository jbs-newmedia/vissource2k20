...
if ($profile_run === 'init') {
    ...
    $ddm4_elements['send']['user_password']['validation']['length_min'] = Settings::getIntVar(
        'vis2_user_password_length_min'
    );
    $ddm4_elements['send']['user_password']['validation']['length_max'] = Settings::getIntVar(
