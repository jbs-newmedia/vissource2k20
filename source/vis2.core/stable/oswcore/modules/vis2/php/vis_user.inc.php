...
$ddm4_object['general']['status_keys']['user_status'][0] = [
    'value' => '0',
    'class' => 'danger',
];
$ddm4_object['data'] = [];
...
$ddm4_elements['data']['user_form']['options']['data'] = [
    'Herr' => 'Herr',
    'Frau' => 'Frau',
];
...
$ddm4_elements['data']['user_gender']['options']['data'] = [
    '0' => 'Keine Angabe',
    '1' => 'Männlich',
    '2' => 'Weiblich',
];
...
$ddm4_elements['data']['user_password']['validation']['length_min'] = Settings::getIntVar(
    'vis2_user_password_length_min'
);
$ddm4_elements['data']['user_password']['validation']['length_max'] = Settings::getIntVar(
    'vis2_user_password_length_max'
);
...
$ddm4_elements['data']['user_phone']['validation']['preg'] = Settings::getStringVar('vis2_user_phone_preg');
...
$ddm4_elements['data']['user_fax']['validation']['preg'] = Settings::getStringVar('vis2_user_fax_preg');
...
$ddm4_elements['data']['user_mobile']['validation']['preg'] = Settings::getStringVar('vis2_user_mobile_preg');
...
if ($VIS2_Main->getBoolVar('tool_use_mandant') === true) {
    ...
    $ddm4_elements['data']['vis2_user_mandant']['options']['tool_id'] = $VIS2_Main->getToolId();
}
...
if ($VIS2_Main->getBoolVar('tool_use_mandant') === true) {
    ...
    $ddm4_elements['finish']['vis2_user_mandant_write']['options']['tool_id'] = $VIS2_Main->getToolId();
    $ddm4_elements['finish']['vis2_user_mandant_write']['options']['tool_name'] = $VIS2_Main->getToolName();
}
