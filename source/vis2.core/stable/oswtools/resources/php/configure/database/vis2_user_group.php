 ...
 * init
 */
$__datatable_table='vis2_user_group';
...
CREATE TABLE :table: (
	...
	user_group_create_time int(11) unsigned NOT NULL DEFAULT 0,
	user_group_create_user_id int(11) unsigned NOT NULL DEFAULT 0,
	user_group_update_time int(11) unsigned NOT NULL DEFAULT 0,
	user_group_update_user_id int(11) unsigned NOT NULL DEFAULT 0,
	KEY user_id (user_id),
