 ...
 * init
 */
$__datatable_table='vis2_mandant';
...
CREATE TABLE :table: (
	...
	mandant_number int(11) unsigned NOT NULL DEFAULT 0,
	mandant_name_intern varchar(32) NOT NULL DEFAULT \'\',
	mandant_name varchar(32) NOT NULL DEFAULT \'\',
	mandant_description varchar(128) NOT NULL DEFAULT \'\',
	mandant_ispublic tinyint(1) unsigned NOT NULL DEFAULT 0,
	mandant_create_time int(11) unsigned NOT NULL DEFAULT 0,
	mandant_create_user_id int(11) unsigned NOT NULL DEFAULT 0,
	mandant_update_time int(11) unsigned NOT NULL DEFAULT 0,
	mandant_update_user_id int(11) unsigned NOT NULL DEFAULT 0,
	PRIMARY KEY (mandant_id),
	KEY tool_id (tool_id),
	KEY mandant_number (mandant_number),
	KEY mandant_name_intern (mandant_name_intern),
	KEY mandant_ispublic (mandant_ispublic),
	KEY mandant_create_time (mandant_create_time),
