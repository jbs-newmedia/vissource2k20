 ...
 * init
 */
$__datatable_table='vis2_user_tool';
...
CREATE TABLE :table: (
	...
	user_tool_create_time int(11) unsigned NOT NULL DEFAULT 0,
	user_tool_create_user_id int(11) unsigned NOT NULL DEFAULT 0,
	user_tool_update_time int(11) unsigned NOT NULL DEFAULT 0,
	user_tool_update_user_id int(11) unsigned NOT NULL DEFAULT 0,
	KEY user_id (user_id),
	KEY tool_id (tool_id),
	KEY user_tool_create_time (user_tool_create_time),
	KEY user_tool_create_user_id (user_tool_create_user_id),
	KEY user_tool_update_time (user_tool_update_time),
	KEY user_tool_update_user_id (user_tool_update_user_id)
