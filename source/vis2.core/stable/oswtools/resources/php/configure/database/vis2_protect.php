 ...
 * init
 */
$__datatable_table='vis2_protect';
...
CREATE TABLE :table: (
	...
	protect_create_time int(11) NOT NULL DEFAULT 0,
	protect_create_user_id int(11) NOT NULL DEFAULT 0,
	protect_update_time int(11) NOT NULL DEFAULT 0,
	protect_update_user_id int(11) NOT NULL DEFAULT 0,
