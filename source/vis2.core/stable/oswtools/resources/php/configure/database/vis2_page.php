...
CREATE TABLE :table: (
	...
	page_name_intern varchar(64) NOT NULL DEFAULT \'\',
	page_name varchar(64) NOT NULL DEFAULT \'\',
	page_description varchar(128) NOT NULL DEFAULT \'\',
	page_ispublic tinyint(1) unsigned NOT NULL DEFAULT 0,
	page_create_time int(11) unsigned NOT NULL DEFAULT 0,
	page_create_user_id int(11) unsigned NOT NULL DEFAULT 0,
	page_update_time int(11) unsigned NOT NULL DEFAULT 0,
	page_update_user_id int(11) unsigned NOT NULL DEFAULT 0,
	PRIMARY KEY (page_id),
	KEY tool_id (tool_id),
	KEY page_name_intern (page_name_intern),
	KEY page_name (page_name),
	KEY page_ispublic (page_ispublic),
	KEY page_create_time (page_create_time),
	KEY page_create_user_id (page_create_user_id),
	KEY page_update_time (page_update_time),
	KEY page_update_user_id (page_update_user_id)
