 ...
 * init
 */
$__datatable_table='vis2_group_permission';
...
CREATE TABLE :table: (
	...
	permission_page varchar(64) NOT NULL DEFAULT \'\',
	permission_flag varchar(16) NOT NULL DEFAULT \'\',
	group_permission_create_time int(11) unsigned NOT NULL DEFAULT 0,
	group_permission_create_user_id int(11) unsigned NOT NULL DEFAULT 0,
	group_permission_update_time int(11) unsigned NOT NULL DEFAULT 0,
	group_permission_update_user_id int(11) unsigned NOT NULL DEFAULT 0,
	KEY group_id (group_id),
	KEY permission_page (permission_page),
	KEY permission_flag (permission_flag),
	KEY group_permission_create_time (group_permission_create_time),
	KEY group_permission_create_user_id (group_permission_create_user_id),
	KEY group_permission_update_time (group_permission_update_time),
	KEY group_permission_update_user_id (group_permission_update_user_id)
