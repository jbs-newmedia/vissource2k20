 ...
 * init
 */
$__datatable_table='vis2_page_permission';
...
CREATE TABLE :table: (
	...
	page_permission_create_time int(11) unsigned NOT NULL DEFAULT 0,
	page_permission_create_user_id int(11) unsigned NOT NULL DEFAULT 0,
	page_permission_update_time int(11) unsigned NOT NULL DEFAULT 0,
	page_permission_update_user_id int(11) unsigned NOT NULL DEFAULT 0,
	KEY page_id (page_id),
	KEY tool_id (tool_id),
	KEY permission_flag (permission_flag),
	KEY page_permission_create_time (page_permission_create_time),
	KEY page_permission_create_user_id (page_permission_create_user_id),
	KEY page_permission_update_time (page_permission_update_time),
	KEY page_permission_update_user_id (page_permission_update_user_id)
