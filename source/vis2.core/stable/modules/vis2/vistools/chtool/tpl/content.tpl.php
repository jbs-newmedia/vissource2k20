...
<div class="container mx-auto" style="max-width: 600px;">
	...
	<div class="row justify-content-center mt-5 mb-3">
		<div class="col text-muted justify-content-center text-center">
			...
			<?php else:?>
				<?php echo $this->getOptimizedImage(\osWFrame\Core\Settings::getStringVar('vis2_logo_login_name'), ['parameter'=>'class="img-responsive center-block"', 'module'=>\osWFrame\Core\Settings::getStringVar('vis2_logo_login_module'), 'path'=>\osWFrame\Core\Settings::getStringVar('vis2_logo_path'), 'title'=>\osWFrame\Core\Settings::getStringVar('vis2_logo_login_title'), 'longest'=>\osWFrame\Core\Settings::getIntVar('vis2_logo_login_longest'), 'height'=>\osWFrame\Core\Settings::getIntVar('vis2_logo_login_height'), 'width'=>\osWFrame\Core\Settings::getIntVar('vis2_logo_login_width')]) ?>
			<?php endif?>
