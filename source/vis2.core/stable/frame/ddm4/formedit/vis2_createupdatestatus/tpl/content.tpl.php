...
<?php if ($this->getEditElementValue($element, 'title')!=''): ?>
	<h4 class="form-group ddm4_element_header ddm_element_<?php echo $this->getEditElementValue($element, 'id') ?>"><?php echo \osWFrame\Core\HTML::outputString($this->getEditElementValue($element, 'title')) ?></h4>
<?php endif ?>
