	...
	<?php else: ?>
		...
		<?php foreach ($users as $user_id=>$user_name): ?>
			...
			<div class="custom-control custom-checkbox">
				...
				<label class="custom-control-label<?php if ($this->getTemplate()->Form()->getErrorMessage($element)): ?> text-danger<?php endif ?>" for="<?php echo $element.'_'.$user_id ?>0"><?php echo \osWFrame\Core\HTML::outputString($user_name) ?></label>
			</div>
