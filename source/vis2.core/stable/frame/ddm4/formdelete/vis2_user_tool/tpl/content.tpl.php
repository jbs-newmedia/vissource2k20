	...
	<?php else: ?>
		...
		<div class="custom-checkbox">
			<?php if (isset($ar_tool_user[$this->getDeleteElementOption($element, 'tool_id')])&&($ar_tool_user[$this->getDeleteElementOption($element, 'tool_id')]==1)): ?>
				...
				<?php echo '#1# '.\osWFrame\Core\HTML::outputString($this->getDeleteElementOption($element, 'tool_name')) ?>

			<?php else: ?>

				<?php echo '#0# '.\osWFrame\Core\HTML::outputString($this->getDeleteElementOption($element, 'tool_name')) ?>
