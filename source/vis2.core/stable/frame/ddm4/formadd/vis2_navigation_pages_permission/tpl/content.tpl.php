		...
		<?php if ($permission_list!==[]): ?>
			...
			<?php foreach ($permission_list as $permission_flag=>$permission_text): ?>
				...
				<div class="form-check">
					...
					<label class="form-check-label<?php if ($this->getTemplate()->Form()->getErrorMessage($element)!==null): ?> text-danger<?php endif ?>" for="<?php echo $element.'_'.$permission_flag ?>0"><?php echo \osWFrame\Core\HTML::outputString($permission_text) ?></label>
				</div>
