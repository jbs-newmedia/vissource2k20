...
<?php if (\osWFrame\Core\Settings::getAction()!='log'): ?>
	...
	<?php if (($this->getCounter('add_elements')>0)&&($this->getListElementOption($element, 'disable_add')!==true)&&($this->getCounter('search_elements')>0)&&($this->getListElementOption($element, 'disable_search')!==true)): ?>
		...
		<?php if (($this->getCounter('add_elements')>0)&&($this->getListElementOption($element, 'disable_add')!==true)): ?>
			<a class="btn btn-primary float-left d-none d-md-inline" onclick="openDDM4Modal_<?php echo $this->getName() ?>(this, '<?php echo $this->getGroupOption('add_title', 'messages') ?>', 'add', <?php echo $this->getCounter('add_elements') ?>)" title="<?php echo \osWFrame\Core\HTML::outputString($this->getGroupMessage('data_add')) ?>" pageName="<?php echo $this->getTemplate()->buildhrefLink($this->getDirectModule(), 'action=add&modal=1&'.$this->getDirectParameters()) ?>"><i class="fa fa-plus fa-fw"></i> <?php echo $this->getGroupOption('add_title', 'messages') ?>
			</a>
			<a class="btn btn-primary btn-block d-md-none" onclick="openDDM4Modal_<?php echo $this->getName() ?>(this, '<?php echo $this->getGroupOption('add_title', 'messages') ?>', 'add', <?php echo $this->getCounter('add_elements') ?>)" title="<?php echo \osWFrame\Core\HTML::outputString($this->getGroupMessage('data_add')) ?>" pageName="<?php echo $this->getTemplate()->buildhrefLink($this->getDirectModule(), 'action=add&modal=1&'.$this->getDirectParameters()) ?>"><i class="fa fa-plus fa-fw"></i> <?php echo $this->getGroupOption('add_title', 'messages') ?>
			</a>
		<?php endif ?>

		<?php if (($this->getCounter('search_elements')>0)&&($this->getListElementOption($element, 'disable_search')!==true)): ?>
			<a id="ddm4_button_search_edit" class="btn btn-primary d-none<?php if ($this->getParameter('ddm_search_data')!=[]): ?> d-md-inline<?php endif ?> float-right" onclick="openDDM4Modal_<?php echo $this->getName() ?>(this, '<?php echo $this->getGroupOption('search_title', 'messages') ?>', 'search_edit', <?php echo $this->getCounter('search_elements') ?>)" title="<?php echo \osWFrame\Core\HTML::outputString($this->getGroupMessage('data_search')) ?>" pageName="<?php echo $this->getTemplate()->buildhrefLink($this->getDirectModule(), 'action=search&modal=1&'.$this->getDirectParameters()) ?>"><i class="fa fa-search fa-fw"></i> <?php echo $this->getGroupOption('edit_search_title', 'messages') ?>
			</a>
			<a id="ddm4_button_search_edit" class="btn btn-primary btn-block<?php if ($this->getParameter('ddm_search_data')==[]): ?> d-none<?php endif ?> d-md-none mt-3" onclick="openDDM4Modal_<?php echo $this->getName() ?>(this, '<?php echo $this->getGroupOption('search_title', 'messages') ?>', 'search_edit', <?php echo $this->getCounter('search_elements') ?>)" title="<?php echo \osWFrame\Core\HTML::outputString($this->getGroupMessage('data_search')) ?>" pageName="<?php echo $this->getTemplate()->buildhrefLink($this->getDirectModule(), 'action=search&modal=1&'.$this->getDirectParameters()) ?>"><i class="fa fa-search fa-fw"></i> <?php echo $this->getGroupOption('edit_search_title', 'messages') ?>
			</a>
			<a id="ddm4_button_search_submit" class="btn btn-primary d-none<?php if ($this->getParameter('ddm_search_data')==[]): ?> d-md-inline<?php endif ?> float-right" onclick="openDDM4Modal_<?php echo $this->getName() ?>(this, '<?php echo $this->getGroupOption('search_title', 'messages') ?>', 'search', <?php echo $this->getCounter('search_elements') ?>)" title="<?php echo \osWFrame\Core\HTML::outputString($this->getGroupMessage('data_search')) ?>" pageName="<?php echo $this->getTemplate()->buildhrefLink($this->getDirectModule(), 'action=search&modal=1&'.$this->getDirectParameters()) ?>"><i class="fa fa-search fa-fw"></i> <?php echo $this->getGroupOption('search_title', 'messages') ?>
			</a>
			<a id="ddm4_button_search_submit" class="btn btn-primary btn-block<?php if ($this->getParameter('ddm_search_data')!=[]): ?> d-none<?php endif ?> d-md-none mt-3" onclick="openDDM4Modal_<?php echo $this->getName() ?>(this, '<?php echo $this->getGroupOption('search_title', 'messages') ?>', 'search', <?php echo $this->getCounter('search_elements') ?>)" title="<?php echo \osWFrame\Core\HTML::outputString($this->getGroupMessage('data_search')) ?>" pageName="<?php echo $this->getTemplate()->buildhrefLink($this->getDirectModule(), 'action=search&modal=1&'.$this->getDirectParameters()) ?>"><i class="fa fa-search fa-fw"></i> <?php echo $this->getGroupOption('search_title', 'messages') ?>
			</a>
		<?php endif ?>
