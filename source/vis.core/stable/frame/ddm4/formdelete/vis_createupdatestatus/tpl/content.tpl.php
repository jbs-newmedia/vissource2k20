...
<?php if ($this->getDeleteElementOption($element, 'display_create_time')==true): ?>
	<div class="form-group<?php if ($this->getTemplate()->Form()->getErrorMessage($element)): ?> has-error<?php endif ?> ddm_element_<?php echo $this->getDeleteElementValue($element, 'id') ?>">
		...
		<?php else: ?><?php if ($this->getDeleteElementOption($element, 'month_asname')===true): ?>
			<div class="form-control readonly"><?php echo \osWFrame\Core\DateTime::strftime(str_replace('%m.', ' %B ', $this->getDeleteElementOption($element, 'date_format')), $this->getDeleteElementStorage($this->getDeleteElementOption($element, 'prefix').'create_time')) ?> <?php echo \osWFrame\Core\HTML::outputString($this->getGroupMessage('text_clock')) ?></div>
		<?php else: ?>
			<div class="form-control readonly"><?php echo \osWFrame\Core\DateTime::strftime($this->getDeleteElementOption($element, 'date_format'), $this->getDeleteElementStorage($this->getDeleteElementOption($element, 'prefix').'create_time')) ?> <?php echo \osWFrame\Core\HTML::outputString($this->getGroupMessage('text_clock')) ?></div>
		<?php endif ?><?php endif ?>
	</div>
<?php endif ?>
...
<?php if ($this->getDeleteElementOption($element, 'display_create_user')==true): ?>
	<div class="form-group<?php if ($this->getTemplate()->Form()->getErrorMessage($element)): ?> has-error<?php endif ?> ddm_element_<?php echo $this->getDeleteElementValue($element, 'id') ?>">
		...
		<?php if (($this->getDeleteElementStorage($this->getDeleteElementOption($element, 'prefix').'create_user_id')=='')||($this->getDeleteElementStorage($this->getDeleteElementOption($element, 'prefix').'create_user_id')=='0')||(\VIS\Core\Manager::getUsernameById($this->getDeleteElementStorage($this->getDeleteElementOption($element, 'prefix').'create_user_id'))=='')): ?>
			<div class="form-control readonly">---</div>
		<?php else: ?>
			<div class="form-control readonly"><?php echo \osWFrame\Core\HTML::outputString(\VIS\Core\Manager::getUsernameById($this->getDeleteElementStorage($this->getDeleteElementOption($element, 'prefix').'create_user_id'))) ?></div>
		<?php endif ?>
	</div>
<?php endif ?>
...
<?php if ($this->getDeleteElementOption($element, 'display_update_time')==true): ?>
	<div class="form-group<?php if ($this->getTemplate()->Form()->getErrorMessage($element)): ?> has-error<?php endif ?> ddm_element_<?php echo $this->getDeleteElementValue($element, 'id') ?>">
		...
		<?php if (($this->getDeleteElementStorage($this->getDeleteElementOption($element, 'prefix').'update_time')=='')||($this->getDeleteElementStorage($this->getDeleteElementOption($element, 'prefix').'update_time')=='0')): ?>
			<div class="form-control readonly">---</div>
		<?php else: ?><?php if ($this->getDeleteElementOption($element, 'month_asname')===true): ?>
			<div class="form-control readonly"><?php echo \osWFrame\Core\DateTime::strftime(str_replace('%m.', ' %B ', $this->getDeleteElementOption($element, 'date_format')), $this->getDeleteElementStorage($this->getDeleteElementOption($element, 'prefix').'update_time')) ?> <?php echo \osWFrame\Core\HTML::outputString($this->getGroupMessage('text_clock')) ?></div>
		<?php else: ?>
			<div class="form-control readonly"><?php echo \osWFrame\Core\DateTime::strftime($this->getDeleteElementOption($element, 'date_format'), $this->getDeleteElementStorage($this->getDeleteElementOption($element, 'prefix').'update_time')) ?> <?php echo \osWFrame\Core\HTML::outputString($this->getGroupMessage('text_clock')) ?></div>
		<?php endif ?><?php endif ?>
	</div>
<?php endif ?>
...
<?php if ($this->getDeleteElementOption($element, 'display_update_user')==true): ?>
	<div class="form-group<?php if ($this->getTemplate()->Form()->getErrorMessage($element)): ?> has-error<?php endif ?> ddm_element_<?php echo $this->getDeleteElementValue($element, 'id') ?>">
		...
		<?php if (($this->getDeleteElementStorage($this->getDeleteElementOption($element, 'prefix').'update_user_id')=='')||($this->getDeleteElementStorage($this->getDeleteElementOption($element, 'prefix').'update_user_id')=='0')||(\VIS\Core\Manager::getUsernameById($this->getDeleteElementStorage($this->getDeleteElementOption($element, 'prefix').'update_user_id'))=='')): ?>
			<div class="form-control readonly">---</div>
		<?php else: ?>
			<div class="form-control readonly"><?php echo \osWFrame\Core\HTML::outputString(\VIS\Core\Manager::getUsernameById($this->getDeleteElementStorage($this->getDeleteElementOption($element, 'prefix').'update_user_id'))) ?></div>
		<?php endif ?>
	</div>
<?php endif ?>