...
<?php if ($this->getEditElementOption($element, 'display_create_user')==true): ?>
	<div class="form-group ddm_element_<?php echo $this->getEditElementValue($element, 'id') ?>">
		...
		<?php if (($this->getEditElementStorage($this->getEditElementOption($element, 'prefix').'create_user_id')=='')||($this->getEditElementStorage($this->getEditElementOption($element, 'prefix').'create_user_id')=='0')||(\VIS\Core\Manager::getUsernameById($this->getEditElementStorage($this->getEditElementOption($element, 'prefix').'create_user_id'))=='')): ?>
			<div class="form-control readonly">---</div>
		<?php else: ?>
			<div class="form-control readonly"><?php echo \osWFrame\Core\HTML::outputString(\VIS\Core\Manager::getUsernameById($this->getEditElementStorage($this->getEditElementOption($element, 'prefix').'create_user_id'))) ?></div>
		<?php endif ?>
	</div>
<?php endif ?>
...
<?php if ($this->getEditElementOption($element, 'display_update_user')==true): ?>
	<div class="form-group ddm_element_<?php echo $this->getEditElementValue($element, 'id') ?>">
		...
		<?php if (($this->getEditElementStorage($this->getEditElementOption($element, 'prefix').'update_user_id')=='')||($this->getEditElementStorage($this->getEditElementOption($element, 'prefix').'update_user_id')=='0')||(\VIS\Core\Manager::getUsernameById($this->getEditElementStorage($this->getEditElementOption($element, 'prefix').'update_user_id'))=='')): ?>
			<div class="form-control readonly">---</div>
		<?php else: ?>
			<div class="form-control readonly"><?php echo \osWFrame\Core\HTML::outputString(\VIS\Core\Manager::getUsernameById($this->getEditElementStorage($this->getEditElementOption($element, 'prefix').'update_user_id'))) ?></div>
		<?php endif ?>
	</div>
<?php endif ?>