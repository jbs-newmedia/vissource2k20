...
<div class="form-group ddm_element_<?php echo $this->getAddElementValue($element, 'id') ?>">
	...
	<?php if ($this->getAddElementOption($element, 'read_only')===true): ?>
		...
		<?php foreach (\VIS\Core\Manager::getNavigationReal(0, $this->getGroupOption('navigation_level'), $this->getAddElementOption($element, 'tool_id')) as $navigation_element): ?>

			<?php echo vis_manager_group_permission($this, $element, $navigation_element, $ar_permission, true) ?>
	...
	<?php else: ?>
		...
		<?php foreach (\VIS\Core\Manager::getNavigationReal(0, $this->getGroupOption('navigation_level'), $this->getAddElementOption($element, 'tool_id')) as $navigation_element): ?>
			...
			<?php echo vis_manager_group_permission($this, $element, $navigation_element, $ar_permission) ?>
