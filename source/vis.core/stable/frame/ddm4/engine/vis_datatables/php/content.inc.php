...
if (in_array(\osWFrame\Core\Settings::getAction(), ['log', 'log_ajax'])) {
	...
	$ddm4_elements['data']['log_value_user_id_new']['options']['data']=VIS\Core\Manager::getUsers();
	...
	$ddm4_elements['data']['log_value_user_id_old']['options']['data']=VIS\Core\Manager::getUsers();
