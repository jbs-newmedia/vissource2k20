...
class Manager {
	...
	public static function loadUserGroupByUserId(int $user_id, int $tool_id):array {
		...
		if ($tool_id==0) {
			...
			$QloadData->prepare('SELECT * FROM :table_vis_user_group: WHERE user_id=:user_id: AND tool_id=:tool_id:');
		}
		$QloadData->bindTable(':table_vis_user_group:', 'vis_user_group');
	...
	public static function loadUserMandantenByUserId(int $user_id, int $tool_id):array {
		...
		if ($tool_id==0) {
			...
			$QloadData->prepare('SELECT * FROM :table_vis_user_mandant: WHERE user_id=:user_id: AND tool_id=:tool_id:');
		}
		$QloadData->bindTable(':table_vis_user_mandant:', 'vis_user_mandant');
		$QloadData->bindInt(':user_id:', $user_id);
		$QloadData->bindInt(':tool_id:', $tool_id);
	...
	public static function loadUserTool(int $user_id, int $tool_id):array {
		...
		if ($tool_id==0) {
			...
			$QloadData->prepare('SELECT * FROM :table_vis_user_tool: WHERE user_id=:user_id: AND tool_id=:tool_id:');
		}
	...
	public static function delTool(int $tool_id) {
		...
		// vis_group
		$QdeleteData->prepare('DELETE FROM :table_vis_group: WHERE tool_id=:tool_id:');
		$QdeleteData->bindTable(':table_vis_group:', 'vis_group');
		$QdeleteData->bindInt(':tool_id:', $tool_id);
		$QdeleteData->execute();

		// vis_mandant
		$QdeleteData->prepare('DELETE FROM :table_vis_mandant: WHERE tool_id=:tool_id:');
		$QdeleteData->bindTable(':table_vis_mandant:', 'vis_mandant');
		$QdeleteData->bindInt(':tool_id:', $tool_id);
		$QdeleteData->execute();

		// vis_navigation
		$QdeleteData->prepare('DELETE FROM :table_vis_navigation: WHERE tool_id=:tool_id:');
		$QdeleteData->bindTable(':table_vis_navigation:', 'vis_navigation');
		$QdeleteData->bindInt(':tool_id:', $tool_id);
		$QdeleteData->execute();

		// vis_page
		$QdeleteData->prepare('DELETE FROM :table_vis_page: WHERE tool_id=:tool_id:');
		$QdeleteData->bindTable(':table_vis_page:', 'vis_page');
		$QdeleteData->bindInt(':tool_id:', $tool_id);
		$QdeleteData->execute();

		// vis_page_permission
		$QdeleteData->prepare('DELETE FROM :table_vis_page_permission: WHERE tool_id=:tool_id:');
		$QdeleteData->bindTable(':table_vis_page_permission:', 'vis_page_permission');
		$QdeleteData->bindInt(':tool_id:', $tool_id);
		$QdeleteData->execute();

		// vis_permission
		$QdeleteData->prepare('DELETE FROM :table_vis_permission: WHERE tool_id=:tool_id:');
		$QdeleteData->bindTable(':table_vis_permission:', 'vis_permission');
		$QdeleteData->bindInt(':tool_id:', $tool_id);
		$QdeleteData->execute();

		// vis_protect
		$QdeleteData->prepare('DELETE FROM :table_vis_protect: WHERE tool_id=:tool_id:');
		$QdeleteData->bindTable(':table_vis_protect:', 'vis_protect');
		$QdeleteData->bindInt(':tool_id:', $tool_id);
		$QdeleteData->execute();

		// vis_tool
		$QdeleteData->prepare('DELETE FROM :table_vis_tool: WHERE tool_id=:tool_id:');
		$QdeleteData->bindTable(':table_vis_tool:', 'vis_tool');
		$QdeleteData->bindInt(':tool_id:', $tool_id);
		$QdeleteData->execute();

		// vis_user_group
		$QdeleteData->prepare('DELETE FROM :table_vis_user_group: WHERE tool_id=:tool_id:');
		$QdeleteData->bindTable(':table_vis_user_group:', 'vis_user_group');
		$QdeleteData->bindInt(':tool_id:', $tool_id);
		$QdeleteData->execute();

		// vis_user_tool
		$QdeleteData->prepare('DELETE FROM :table_vis_user_tool: WHERE tool_id=:tool_id:');
		$QdeleteData->bindTable(':table_vis_user_tool:', 'vis_user_tool');
		$QdeleteData->bindInt(':tool_id:', $tool_id);
		$QdeleteData->execute();
	}
