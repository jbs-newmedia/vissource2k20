			...
			<div class="login-panel card card-default">
				...
				<div class="card-body mb-2">
					<div class="form-group">
						<label for="vis_login_email" class="form-control-label mb-1">E-Mail:</label>
						<?php echo $this->Form()->drawTextField('vis_login_email', '', ['input_class'=>'form-control', 'input_errorclass'=>'is-invalid']) ?>
						<div class="invalid-feedback"><?php echo $this->Form()->getErrorMessage('vis_login_email') ?></div>
					</div>
					<div class="form-group mt-3">
						<label for="vis_login_password" class="form-control-label mb-1">Password:</label>
						<?php echo $this->Form()->drawPasswordField('vis_login_password', '', ['input_class'=>'form-control', 'input_errorclass'=>'is-invalid']) ?>
						<div class="invalid-feedback"><?php echo $this->Form()->getErrorMessage('vis_login_password') ?></div>
					</div>
				</div>
