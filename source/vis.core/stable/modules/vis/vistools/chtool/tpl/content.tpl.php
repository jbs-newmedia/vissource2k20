...
<div class="container mx-auto" style="max-width: 600px;">
	...
	<?php echo $this->Form()->startForm('form_change', 'current', 'vistool='.$VIS_Main->getTool()); ?>
	<div class="row justify-content-center mt-5 mb-3">
		<div class="col">
			<div class="login-panel card card-default">
				...
				<div class="card-body mb-2">
					<div class="form-group">
						<label for="vis_login_email" class="form-control-label mb-1">Benutzer:</label>
						<div class="form-control"><?php echo \osWFrame\Core\HTML::outputString($VIS_User->getName()) ?>
							<span style="float: right;"><a href="<?php echo $this->buildhrefLink('current') ?>">ändern</a></span>
						</div>
					</div>
					<div class="form-group mt-3">
						<label for="vis_login_tool" class="form-control-label mb-1">Programm:</label>
						<?php echo $this->Form()->drawSelectField('vis_login_tool', [''=>'']+$VIS_User->getToolsSelectArray(), '', ['input_class'=>'selectpicker form-control', 'input_errorclass'=>'is-invalid', 'input_parameter'=>' data-style="form-select custom-select"']) ?>
						<div class="invalid-feedback"><?php echo $this->Form()->getErrorMessage('vis_login_tool') ?></div>
					</div>
				</div>
	...
	<div class="row justify-content-center mb-3">
		<div class="col text-muted text-center">
			<small>v<?php echo $VIS_Main::getVersion() ?></small>
		</div>
	</div>
</div>