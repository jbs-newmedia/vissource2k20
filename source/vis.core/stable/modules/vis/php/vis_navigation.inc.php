 ...
 */
$tool_details=$VIS_Main->getToolDetails();
$navigation_links=[];
...
if (in_array($ddm_navigation_id, [1])) {
	...
	$ddm4_elements['data']['tool_id']['options']['default_value']=$VIS_Main->getToolId();
	...
	$ddm4_elements['finish']['vis_navigation_permission_delete']['options']['tool_id']=$VIS_Main->getToolId();
...
if (in_array($ddm_navigation_id, [2])) {
	...
	$ddm4_elements['data']['vis_navigation_pages_permission']['options']['tool_id']=$VIS_Main->getToolId();
	...
	$ddm4_elements['finish']['vis_navigation_pages_permission_write']['options']['tool_id']=$VIS_Main->getToolId();
	...
	$ddm4_elements['finish']['vis_navigation_pages_permission_delete']['options']['tool_id']=$VIS_Main->getToolId();
...
if (in_array($ddm_navigation_id, [3])) {
	...
	$ar_level=[];
	$ar_data[0]='-';
	foreach (\VIS\Core\Manager::getNavigationReal(0, $osW_DDM4->getGroupOption('navigation_level'), $VIS_Main->getToolId()) as $navigation_element_1) {
	...
	$ddm4_elements['data']['page_id']['options']['data']=\VIS\Core\Manager::getPagesByToolId($VIS_Main->getToolId());
	...
	$ddm4_elements['finish']['vis_navigation_sort']['options']['tool_id']=$VIS_Main->getToolId();
	...
	$ddm4_elements['finish']['vis_navigation_delete']['options']['tool_id']=$VIS_Main->getToolId();
...
if (in_array($ddm_navigation_id, [4])) {
	...
	$ddm4_elements['data']['vis_group_permission']['options']['tool_id']=$VIS_Main->getToolId();
	...
	$ddm4_elements['data']['vis_group_user']['options']['tool_id']=$VIS_Main->getToolId();
	...
	$ddm4_elements['finish']['vis_group_permission_write']['options']['tool_id']=$VIS_Main->getToolId();
	...
	$ddm4_elements['finish']['vis_group_user_write']['options']['tool_id']=$VIS_Main->getToolId();
	...
	$ddm4_elements['finish']['vis_group_delete']['options']['tool_id']=$VIS_Main->getToolId();
...
if (in_array($ddm_navigation_id, [5])) {
	 ...
	 * Data: Benutzer
	 */
	$ddm4_elements['data']['vis_mandanten_user']=[];
	$ddm4_elements['data']['vis_mandanten_user']['module']='vis_mandanten_user';
	$ddm4_elements['data']['vis_mandanten_user']['title']='Benutzer';
	$ddm4_elements['data']['vis_mandanten_user']['options']=[];
	$ddm4_elements['data']['vis_mandanten_user']['options']['tool_id']=$VIS_Main->getToolId();
	...
	/*
	 * Finish: VIS_Mandant_User_Write
	 */
	$ddm4_elements['finish']['vis_mandant_user_write']=[];
	$ddm4_elements['finish']['vis_mandant_user_write']['module']='vis_mandant_user_write';
	$ddm4_elements['finish']['vis_mandant_user_write']['options']=[];
	$ddm4_elements['finish']['vis_mandant_user_write']['options']['tool_id']=$VIS_Main->getToolId();
	$ddm4_elements['finish']['vis_mandant_user_write']['options']['tool_name']=$VIS_Main->getToolName();
