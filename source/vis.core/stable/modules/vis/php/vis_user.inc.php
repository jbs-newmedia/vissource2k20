...
$ddm4_object['database']['table']='vis_user';
...
$ddm4_object['database']['order_case']['user_update_user_id']=\VIS\Core\Manager::getUsers();
...
$ddm4_elements['data']['user_password']['validation']['length_min']=\osWFrame\Core\Settings::getIntVar('vis_user_password_length_min');
$ddm4_elements['data']['user_password']['validation']['length_max']=\osWFrame\Core\Settings::getIntVar('vis_user_password_length_max');
...
$ddm4_elements['data']['user_phone']['validation']['preg']=\osWFrame\Core\Settings::getStringVar('vis_user_phone_preg');
...
$ddm4_elements['data']['user_fax']['validation']['preg']=\osWFrame\Core\Settings::getStringVar('vis_user_fax_preg');
...
$ddm4_elements['data']['user_mobile']['validation']['preg']=\osWFrame\Core\Settings::getStringVar('vis_user_mobile_preg');
 ...
 * Data: Tools
 */
$ddm4_elements['data']['vis_user_tool']=[];
$ddm4_elements['data']['vis_user_tool']['module']='vis_user_tool';
$ddm4_elements['data']['vis_user_tool']['title']='Tools';
$ddm4_elements['data']['vis_user_tool']['options']=[];
$ddm4_elements['data']['vis_user_tool']['options']['tool_id']=$VIS_Main->getToolId();
$ddm4_elements['data']['vis_user_tool']['options']['tool_name']=$VIS_Main->getToolName();

/*
 * Data: Gruppen
 */
$ddm4_elements['data']['vis_user_group']=[];
$ddm4_elements['data']['vis_user_group']['module']='vis_user_group';
$ddm4_elements['data']['vis_user_group']['title']='Gruppen';
$ddm4_elements['data']['vis_user_group']['options']=[];
$ddm4_elements['data']['vis_user_group']['options']['tool_id']=$VIS_Main->getToolId();

if ($VIS_Main->getBoolVar('tool_use_mandant')===true) {
	/*
	 * Data: Gruppen
	 */
	$ddm4_elements['data']['vis_user_mandant']=[];
	$ddm4_elements['data']['vis_user_mandant']['module']='vis_user_mandant';
	$ddm4_elements['data']['vis_user_mandant']['title']='Mandanten';
	$ddm4_elements['data']['vis_user_mandant']['options']=[];
	$ddm4_elements['data']['vis_user_mandant']['options']['tool_id']=$VIS_Main->getToolId();
}
...
$ddm4_elements['data']['vis_createupdatestatus']['options']['order']=true;
$ddm4_elements['data']['vis_createupdatestatus']['options']['search']=true;
$ddm4_elements['data']['vis_createupdatestatus']['options']['prefix']='user_';
...
$ddm4_elements['data']['vis_createupdatestatus']['options']['text_yes']='Aktiviert';
$ddm4_elements['data']['vis_createupdatestatus']['options']['text_no']='Deaktiviert';
...
$ddm4_elements['finish']['vis_store_form_data']['options']['createupdatestatus_prefix']='user_';

/*
 * Finish: VIS_User_Tool_Write
 */
$ddm4_elements['finish']['vis_user_tool_write']=[];
$ddm4_elements['finish']['vis_user_tool_write']['module']='vis_user_tool_write';
$ddm4_elements['finish']['vis_user_tool_write']['options']=[];
$ddm4_elements['finish']['vis_user_tool_write']['options']['createupdatestatus_prefix']='user_';
$ddm4_elements['finish']['vis_user_tool_write']['options']['tool_id']=$VIS_Main->getToolId();
$ddm4_elements['finish']['vis_user_tool_write']['options']['tool_name']=$VIS_Main->getToolName();

/*
 * Finish: VIS_User_Group_Write
 */
$ddm4_elements['finish']['vis_user_group_write']=[];
$ddm4_elements['finish']['vis_user_group_write']['module']='vis_user_group_write';
$ddm4_elements['finish']['vis_user_group_write']['options']=[];
$ddm4_elements['finish']['vis_user_group_write']['options']['createupdatestatus_prefix']='user_';
$ddm4_elements['finish']['vis_user_group_write']['options']['tool_id']=$VIS_Main->getToolId();
$ddm4_elements['finish']['vis_user_group_write']['options']['tool_name']=$VIS_Main->getToolName();

if ($VIS_Main->getBoolVar('tool_use_mandant')===true) {
	/*
	 * Finish: VIS_User_Mandant_Write
	 */
	$ddm4_elements['finish']['vis_user_mandant_write']=[];
	$ddm4_elements['finish']['vis_user_mandant_write']['module']='vis_user_mandant_write';
	$ddm4_elements['finish']['vis_user_mandant_write']['options']=[];
	$ddm4_elements['finish']['vis_user_mandant_write']['options']['createupdatestatus_prefix']='user_';
	$ddm4_elements['finish']['vis_user_mandant_write']['options']['tool_id']=$VIS_Main->getToolId();
	$ddm4_elements['finish']['vis_user_mandant_write']['options']['tool_name']=$VIS_Main->getToolName();
}

/*
 * Finish: VIS_User_Delete
 */
$ddm4_elements['finish']['vis_user_delete']=[];
$ddm4_elements['finish']['vis_user_delete']['module']='vis_user_delete';
